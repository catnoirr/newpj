  ...
  return (
    <div className="flex flex-col items-center p-8 bg-white">
      ...
      <div className="text-center ">
        <h1 className="text-5xl font-medium mb-8">Our Story</h1>
      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center w-full  mt-8">
        <div className="  flex flex-col justify-between mb-8 lg:mb-0 lg:mr-8 w-full lg:w-1/2">
          <img src="./product.png" alt="advertising pic" />
        </div>
